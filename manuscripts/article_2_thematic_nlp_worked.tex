...
Documents were retrieved from Scopus and Web of Science using search strategies targeting natural sciences didactics, science education pedagogy, and STEM teaching methodologies. Searches covered Title, Abstract, and Keywords fields, restricting to peer-reviewed articles and reviews in English from January 2000 through December 2025. After merging via \texttt{biblio\-metrix::\allowbreak merge\-Db\-Sources()} \cite{Aria2017} and quality control, the final corpus comprised 321 unique documents.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figuras/00_lda_optimization_metrics.png}
...
Implementation used the \texttt{topic\-models} package \cite{Grun2011} in R.
...
Geographic variation was examined by extracting author country affiliations from metadata fields. For each country with $\geq 10$ documents (ensuring robust estimates), we calculated topic prevalence:
...
\label{tab:topics}
\scriptsize
\begin{tabular}{@{}p{0.15\textwidth}p{0.45\textwidth}cc@{}}
\toprule
Topic Label & Top 10 Terms & Docs & Prev. \\
\midrule
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.95\textwidth]{figuras/03_wordclouds_por_topic.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figuras/01_topics_heatmap_temporal.png}
...
\toprule
Year & Inq & Env & STEM & Teach & Tech & Assess & Equity & Sci Lit & Concept \\
\midrule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figuras/02_topics_alluvial_evolution.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{figuras/05_trend_topics_timeline.png}
...
\begin{tabular}{@{}lcccc@{}}
\toprule
Country & Docs & Primary Topic & Secondary Topic & Tertiary Topic \\
\midrule
...
Country-level analysis of the most productive nations (15 countries with $\geq 10$ documents) revealed significant thematic specialization that reflects distinct national priorities and regional policy frameworks (Figure \ref{fig:geography}, Table \ref{tab:countries}). The United States (35 documents) demonstrated a highly diversified and balanced coverage across Inquiry-Based Science Education (25\%), Environmental Education (23\%), and STEM Integration (17\%), suggesting a mature research ecosystem that addresses multiple pedagogical and societal challenges simultaneously. Germany (29 documents) showed a marked concentration on Environmental Education (48\%), a trend that directly reflects robust national sustainability policies and the long-standing integration of ecological literacy within the German secondary curricula. Turkey (19 documents) emphasized Inquiry-Based Science Education (42\%), closely aligning with recent national curriculum reforms that promote a transition from traditional instruction toward student-centered, constructivist methodologies. China (18 documents) specialized heavily in Technology-Enhanced Learning (33\%) and STEM Integration (28\%), mirroring massive strategic investments in digital educational infrastructure and a state-led push for scientific and technological competitiveness. Finally, Spain (12 documents) prioritized Environmental Education (42\%) and Equity \& Social Justice (25\%), reflecting a research agenda heavily influenced by European Union mandates regarding inclusive education and the transition toward a green economy.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.85\textwidth]{figuras/06_distribucion_geografica.png}
